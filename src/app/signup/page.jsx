...
const SignupSchema = Yup.object().shape({
   ...
   .min(8, 'min 8 character are required'),
          ...
          <form onSubmit={signupForm.handleSubmit}>
            <div className="grid gap-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-red-600 mt-2" id="password-error">8+ characters required</p>
              </div>
              {/* End Form Group */}
              ...
              <div>
                ...
                <p className="text-xs text-red-600 mt-2" id="confirm-password-error">Password does not match the password</p>
              </div>
              {/* End Form Group */}
